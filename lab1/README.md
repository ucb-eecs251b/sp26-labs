...
```
# e.g. git clone git@github.com:ucb-eecs251b/sp26-labs-<username>.git
git clone <your-lab-repo>
cd sp26-labs-<username>
# e.g. git remote add skeleton https://github.com/ucb-eecs251b/sp26-labs.git
